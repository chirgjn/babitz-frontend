  ...
  return (
    <div className={styles.dropdown}>
      ...
      <div className={styles.dropdownContent}>
        ...
        <Link href="/Template/edittemplate">Edit Template</Link>
        <MobileView>
          <Link href="/Dashboard/dashboard">Statistics</Link>
          <Link href="/Dashboard/inventory">Inventory</Link>
          <Link href="/Dashboard/orderlogs">Order Logs</Link>
          <Link href="/Dashboard/paymentlogs">Payment Logs</Link>
        </MobileView>
