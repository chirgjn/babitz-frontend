...
function Sidenav(){
  return (
    ...
    <svg  style={{margin:'20px 0px 0px 10px'}} width="60" height="60" viewBox="0 0 90 77" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <HeadingDiv>
    <ActiveLink activeClassName={styles.active} href="/Dashboard/dashboard">
    <div>
    <Heading>Statistics</Heading>
         ...
         <ActiveLink activeClassName={styles.active} href="/Dashboard/inventory">
         <div>
