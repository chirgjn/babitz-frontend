...
<center>
<Heading1 style={{marginTop:'40px'}}>Welcome Back</Heading1>
<Heading2 style={{marginTop:'40px', marginBottom:'100px'}}>Sign in to continue your account.</Heading2>
...
<button onClick={signUp} style={{border:'none', background:'none', fontFamily:'Oswald', fontSize:'20px', color:'black', outline:'none'}}>Sign Up</button></NormalText>
    </center>
    </div>
    </div>
    </Box>
