...
function Checkout() {
  ...
  const back = () => {
    if (restname != undefined) {
      router.push(`/${restname.Restaurant}/main`);
    }
  };
  const payment = (e) => {
    e.preventDefault();
    let options = {
      ...
      order_id: "order_Hg6abPlBZJO9Mr", //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
